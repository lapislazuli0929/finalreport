...
require("DBconnect.php");
        ...
        if($result=mysqli_query($link,$SQL)){
            ...
            echo "<table border='1'>";
            echo "<td>"."用戶訂單"."</td/><td>"."選料"."</td><td>"."金額"."</td/><td>"."領取方式"."</td/><td>"."外送地址"."</td/><td>"."編輯"."</td>";
            while($row=mysqli_fetch_assoc($result)){
                echo "<tr>";

                echo "<td>".$row["mixd"]."</td><td>".$row["mixm"]."</td><td>".$row["price"]."</td><td>".$row["choose"]."</td><td>".$row["address"]."</td><td><a href='delettest.php?uNo=".$row["ss"]."'>完成訂單</a></td>"."</br>";
                echo "</tr>";
