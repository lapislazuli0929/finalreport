...
require("DBconnect.php");
        ...
        $SQL="SELECT * FROM shopcaradmin";

        if($result=mysqli_query($link,$SQL)){

            echo "<table border='1'>";
            echo "<td>"."用戶訂單"."</td/><td>"."總額"."</td><td>"."領取方式"."</td/><td>"."外送地址"."</td/><td>"."編輯"."</td>";
            while($row=mysqli_fetch_assoc($result)){
                echo "<tr>";

                echo "<td>".$row["alldrink"]."</td><td>".$row["sumprice"]."</td><td>".$row["choose"]."</td><td>".$row["address"]."</td><td><a href='deleteClear.php?uNo=".$row["shNo"]."'>完成訂單</a></td>"."</br>";
                echo "</tr>";
